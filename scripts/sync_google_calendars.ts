...
export const CALENDARS: CalendarSource[] = [
  // Hauptveranstaltungen (Erwachsene & Allgemein)
  {
    ...
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/pankow-default.jpg',
  },
  {
    name: 'SCP Süd',
    ...
    targetAudience: { de: 'Erwachsene & Familien', pl: 'Dorośli i rodziny', en: 'Adults & Families' },
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/schoeneberg-default.jpg',
  },
  {
    name: 'SCP Süd-Ost',
    ...
    targetAudience: { de: 'Erwachsene & Familien', pl: 'Dorośli i rodziny', en: 'Adults & Families' },
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/koepenick-default.jpg',
  },
  {
    ...
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/partner-default.jpg',
  },
  {
    name: 'SCP online',
    ...
    locationRef: 'online',
    targetAudience: { de: 'Alle Interessierten', pl: 'Wszyscy zainteresowani', en: 'All Interested' },
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/online-default.jpg',
  },
  {
    name: 'SCiO',
    ...
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/network-default.jpg',
  },
  // Kinder- & Familienveranstaltungen
  {
    ...
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/kinder-pankow.jpg',
  },
  {
    name: 'SCP Kinder Süd',
    ...
    locationRef: 'schoeneberg',
    targetAudience: { de: 'Kinder & Eltern', pl: 'Dzieci i rodzice', en: 'Children & Parents' },
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/kinder-schoeneberg.jpg',
  },
  {
    ...
    locationRef: 'koepenick',
    targetAudience: { de: 'Kinder & Eltern', pl: 'Dzieci i rodzice', en: 'Children & Parents' },
    defaultImage: 'https://sprachcafe-media-storage.s3.eu-central-1.amazonaws.com/events/kinder-koepenick.jpg',
  },
];
